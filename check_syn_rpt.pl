...
open DST, "> ./syn_rpt/$tile_name.xls" or die;
...
open SRC, "./syn_rpt/$tile_name.xls" or die;
open DST, "> ./syn_rpt/$tile_name.final.xls" or die;
@lines = <SRC>;
@lines = sort @lines;
...
unlink "./syn_rpt/$tile_name.xls";
&waive ("./syn_rpt/$tile_name.postwaived.rpt.gz", "./syn_rpt/$tile_name.waive");
system "sort -u ./syn_rpt/$tile_name.waive > ./syn_rpt/$tile_name.tmp.waive";
#unlink "./syn_rpt/$tile_name.waive";
open TMP, "./syn_rpt/$tile_name.tmp.waive";
open TMP1, ">./syn_rpt/$tile_name.tmp1.waive";
while (<TMP>) {
 chomp;
 $line  = $_;
 $line =~ s/([\.\w]+)\///g;
...
close TMP;
close TMP1;
system "sort -u ./syn_rpt/$tile_name.tmp1.waive > ./syn_rpt/$tile_name.final.waive";
#unlink "./syn_rpt/$tile_name.tmp.waive";
#unlink "./syn_rpt/$tile_name.tmp1.waive";
